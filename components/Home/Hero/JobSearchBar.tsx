  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8 ml-0">
      <div className="flex flex-col md:flex-row bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden">
        <div
          className="flex items-center border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 px-4
        ...
        <button className="bg-cyan-700 text-white px-8 sm:py-6 py-3 cursor-pointer text-sm md:text-base w-full md:w-auto min-w-[140px] whitespace-nowrap hover:bg-cyan-800 transition">
          Search
        </button>
      </div>
    </div>
